 ...
 * Wyznacza następujący ciąg numerów: jeśli, istnieje przekierowanie, będące prefiksem numeru @p num,
 * to dodaje do wyniku wywołania @ref phfwdReverse wszystkie numery,
 * w których prefiks @p num odpowiadający przekierowaniu
 * został zastąpiony odpowiadającym owemu przekierowaniu prefiksem numeru telefonu.
 *  Wynikowe numery są posortowane
